...
class Sw_Portfolio{
	...
	public function Portfolio_Template_Loader( $template ){			
		...
		}elseif ( is_post_type_archive( 'portfolio' ) || is_tax( 'portfolio_cat' ) )  {
			$template = dirname(__FILE__) . '/templates/portfolio-archive.php';
		}
		return $template;
	}
	...
	public function Get_Pcat(){
		...
		$term = array( __( 'All Category Portfolio', 'smartaddons' ) => 0 );
		if( count( $terms ) > 0 ){
		...
		vc_map( array(
		  ...
		  "params" => array(
			 ...
			 array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __( "Description", "smartaddons" ),
				"param_name" => "description",
				"value" => __( "", "smartaddons" ),
				"description" => __( "Description", "smartaddons" )
			 ),
			  array(
				"type" => "checkbox",
				"holder" => "div",
			 ...
			 array(
			  ...
			  array(
				...
				"holder" => "div",
				"class" => "",
				"heading" => __( "Show Tab", "smartaddons" ),
				"param_name" => "show_tab",
				"value" => array( 'Yes' => 'yes', 'No' => 'no' ),
				"description" => __( "Show Tab Filter", "smartaddons" )
			 ),			 
			  array(
				"type" => "dropdown",
				"holder" => "div",
				"class" => "",
				"heading" => __( "Show button loadmore", "smartaddons" ),
				"param_name" => "show_loadmore",
				"value" => array( 'Yes' => 'yes', 'No' => 'no' ),
				"description" => __( "Show button loadmore", "smartaddons" )
			 )
		  )
	   ) );
	}
