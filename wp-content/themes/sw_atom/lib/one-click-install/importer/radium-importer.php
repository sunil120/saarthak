 ...
 if ( !class_exists( 'Radium_Theme_Importer' ) ) {
	...
	class Radium_Theme_Importer {
	    ...
	    public function add_admin() {
			$this->page = add_theme_page('Import Demo Data','Import Demo Data','switch_themes','radium_demo_installer',array($this, 'demo_installer'));
	    ...
	    public function set_demo_data( $file ) {
	        ...
	        if ( !class_exists( 'WP_Import' ) ) {
	            ...
	            $class_wp_import = get_template_directory().'/lib/one-click-install/importer/wordpress-importer.php';
