...
require get_template_directory().'/lib/one-click-install/importer/parsers.php';
...
<?php endif; ?>
	...
	<p class="submit"><input type="submit" class="button" value="<?php esc_html_e( 'Submit', 'yatheme' ); ?>" /></p>
</form>
<?php
	}
