...
if ( !class_exists( 'Radium_Theme_Demo_Data_Importer' ) ) {
	...
	require_once( get_template_directory().'/lib/one-click-install/importer/radium-importer.php' ); //load admin theme data importer
	...
	class Radium_Theme_Demo_Data_Importer extends Radium_Theme_Importer {
		 ...
		 * @var string
		 */
		public $theme_option_name       = __THEME__; //set theme options name here (key used to save theme options). Optiontree option name will be set automatically
		 ...
		 * @var string
		 */
		public $content_demo_file_name  = 'data.xml';
		...
		public function __construct() {
			...
			$this->demo_files_path = get_template_directory().'/lib/one-click-install/demo-data/'; //can
