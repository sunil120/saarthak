...
<div class="wrap">
	...
	<form method="post" action="options.php">
		...
		<table class="form-table">
			...
			<tr valign="top">
				<th scope="row"><?php esc_html_e('Create static front page?', 'yatheme'); ?>
				</th>
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<span><?php esc_html_e('Create static front page?', 'yatheme'); ?> </span>
						</legend>
						<select name="ya_activation_options[create_front_page]"
							id="create_front_page">
							<option selected="selected" value="true">
								<?php esc_html_e('Yes', 'yatheme'); ?>
							</option>
							<option value="false">
								<?php esc_html_e('No', 'yatheme'); ?>
							</option>
			...
			<tr valign="top">
				<th scope="row"><?php esc_html_e('Change permalink structure?', 'yatheme'); ?>
				</th>
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<span><?php esc_html_e('Update permalink structure?', 'yatheme'); ?> </span>
						</legend>
			...
			<tr valign="top">
				<th scope="row"><?php esc_html_e('Change uploads folder?', 'yatheme'); ?></th>
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<span><?php esc_html_e('Update uploads folder?', 'yatheme'); ?> </span>
						</legend>
			...
			<tr valign="top">
				<th scope="row"><?php esc_html_e('Create navigation menu?', 'yatheme'); ?></th>
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<span><?php esc_html_e('Create navigation menu?', 'yatheme'); ?> </span>
						</legend>
			...
			<tr valign="top">
				<th scope="row"><?php esc_html_e('Add pages to menu?', 'yatheme'); ?></th>
				<td>
					<fieldset>
						<legend class="screen-reader-text">
							<span><?php esc_html_e('Add pages to menu?', 'yatheme'); ?> </span>
						</legend>
