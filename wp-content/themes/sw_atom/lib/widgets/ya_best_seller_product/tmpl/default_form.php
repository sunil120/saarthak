...
<p>
			<label for="<?php echo esc_attr( $this->get_field_id('el_class') ); ?>"><?php esc_html_e('El_class', 'yatheme')?></label>
			<br />
...
<p>
			<label for="<?php echo esc_attr( $this->get_field_id('style_title') ); ?>"><?php esc_html_e('Style title ', 'yatheme')?></label>
			<br />
