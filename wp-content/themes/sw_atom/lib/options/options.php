...
// 					);
		...
		public function _options_form(){
			...
			<div class="cpannel-button">
				<button id="cpanel-submit" class="btn btn-inverse" type="submit"><?php esc_html_e( 'SAVE', 'yatheme' ); ?></button>
				<button id="cpanel-reset" class="btn btn-inverse" type="button"><?php esc_html_e( 'RESET', 'yatheme' ); ?></button>
			</div>
			<?php
			echo '</div>';
		...
		function _options_page_html(){
			...
			if(isset($_GET['settings-updated']) && $_GET['settings-updated'] == 'true' && get_transient('ya-opts-saved') == '1'){
				if(isset($this->options['imported']) && $this->options['imported'] == 1){
					...
					echo '<div id="ya-opts-save">'.apply_filters('ya-opts-saved-text-'.$this->args['opt_name'], __('<strong>Settings Saved! - www.FREEWPPREMIUM.com</strong>', 'yatheme')).'</div>';
			...
			do_action('ya-opts-after-section-menu-items-'.$this->args['opt_name'], $this);
						...
						//if(true === $this->args['show_import_export']){
							...
							echo '<a href="javascript:void(0);" id="import_export_default_section_group_li_a" class="ya-opts-group-tab-link-a" data-rel="import_export_default"><img src="'.$this->url.'options/img/glyphicons/glyphicons_082_roundabout.png" /> <span>'.__('Import / Export', 'yatheme').'</span></a>';
							echo '</li>';
							// echo '<li class="divide">&nbsp;</li>';
						// }//if
