<?php
class YA_Options_google_webfonts extends YA_Options{	
	...
	*/
	function render(){
		...
		echo '<p class="description" style="color:red;">'.__('The fonts provided below are free to use custom fonts from the <a href="'.esc_url('http://www.google.com/webfonts').'" target="_blank">Google Web Fonts directory</a>.<br/>Please <a href="'.esc_url('http://www.google.com/webfonts').'" target="_blank">browse the directory</a> to preview a font, then select your choice below.', 'yatheme').'</p>';
