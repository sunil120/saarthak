	...
	*/
	function render(){
		...
		if(isset($this->value) && is_array($this->value)){
			...
			//echo '<li><input type="text" id="'.$this->field['id'].'" name="'.$this->args['opt_name'].'['.$this->field['id'].'][]" value="" class="'.$class.'" /> <a href="javascript:void(0);" class="ya-opts-multi-text-remove">'.__('Remove', 'yatheme').'</a></li>';
		
		}//if
		
		//echo '<li style="display:none;"><input type="text" id="'.$this->field['id'].'" name="" value="" class="'.$class.'" /> <a href="javascript:void(0);" class="ya-opts-multi-text-remove">'.__('Remove', 'yatheme').'</a></li>';
		
		echo '</table>';
		
		echo '<a href="javascript:void(0);" class="ya-opts-multi-field-add" rel-id="'.esc_attr( $this->field['id'] ).'-table" rel-name="'.$this->args['opt_name'].'['.$this->field['id'].'][]">'.__('Add More', 'yatheme').'</a><br/>';
