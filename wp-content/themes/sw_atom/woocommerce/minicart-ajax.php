...
<div class="top-form top-form-minicart ya-minicart pull-right">
	<div class="top-minicart-icon pull-right">
		<span class="shopping-text"><?php esc_html_e('Shopping Cart','yatheme');?></span>
		<?php echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>';  esc_html_e('item(s)', 'yatheme');?> :  <?php echo $woocommerce->cart->get_cart_total(); ?>
		<!--<a class="cart-contents" href="<?php //echo $woocommerce->cart->get_cart_url(); ?>" title="<?php //esc_html_e('View your shopping cart', 'yatheme'); ?>"><?php //echo '<span class="minicart-number">'.$woocommerce->cart->cart_contents_count.'</span>'?></a>-->	
	</div>
