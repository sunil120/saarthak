...
<form action="<?php echo get_permalink( woocommerce_get_page_id( 'myaccount' ) ); ?>" method="post" class="login">
			...
			<div class="block-content">
				<div class="col-reg registered-account">
					...
					<div class="ft-link-p">
						<a href="<?php echo esc_url( wc_lostpassword_url() ); ?>" title="Forgot your password"><?php esc_html_e( 'Forgot your password?', 'woocommerce' ); ?></a>
					</div>
					<div class="actions">
				...
				<div class="col-reg login-customer">
					<h2><?php esc_html_e( 'NEW HERE?', 'yatheme' ); ?></h2>
					<p class="note-reg"><?php esc_html_e( 'Registration is free and easy!', 'yatheme' ); ?></p>
					<ul class="list-log">
					...
					<a href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>" title="Register" class="btn-reg-popup"><?php esc_html_e( 'Create an account', 'woocommerce' ); ?></a>
				</div>
